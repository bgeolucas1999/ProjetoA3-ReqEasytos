 ...
 * @author georg
 */
public class jfListaUser extends javax.swing.JFrame {

    /**
     * Creates new form listaUser
     */
    public jfListaUser() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfListaUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfListaUser().setVisible(true);
            }
        });
    }
...
//        int setar = jtRequisitos.getSelectedRow();
        ...
        try{String sqlSelect = "select * from usuarios";
...
//                jtMaster.setText(rs.getString("master"));
                modelo.addRow(new Object[]{rs.getInt("id"),rs.getString("nome"),rs.getString("email"),rs.getString("fone"),rs.getString("login") });
...
//        int setar = jtRequisitos.getSelectedRow();
        ...
        try{String sqlSelect = "select * from usuarios where "+atributo+" = ?";
        Conexao conexao = new Conexao();
